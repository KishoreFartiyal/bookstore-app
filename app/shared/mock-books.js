...
exports.BOOKS = [
    new book_1.Book('Land of Seven Rivers', 278, "A Brief History of India’s Geography", 'land-of-seven-rivers.jpg', {
        type: 'Paperback',
        pageCount: 331,
    ...
    new book_1.Book('Breaking india: Western Interventions in Dravidian and Dalit Faultlines', 550, "Know about the interventions of the West on the Eastern traditions", 'breaking-india.jpg', {
        type: 'HardCover',
        pageCount: 666,
    ...
    new book_1.Book('I am The Mind', 199, "Imagine if you can understand how others Mind function.", 'I-am-the-mind.jpg', {
        type: 'HardCover',
        pageCount: 254,
        author: 'Deep Trivedi',
    ...
    new book_1.Book('The Monk Who Sold His Ferrari', 280, "A renowned inspirational fiction", 'monk-sold-ferari.jpg', {
        type: 'Paperback',
        pageCount: 254,
        author: 'Robin Sharma',
